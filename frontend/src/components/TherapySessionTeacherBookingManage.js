...
export default function TherapySessionTeacherBookingManage() {
  ...
  const getBooking = () => {
    axios
      .get(`${process.env.REACT_APP_BACKEND_BASE_URL}/therapy-session-teacher/view-booking`)
      .then((res) => {
  ...
  const saveEdit = (bookingid) => {
    axios
      .put(`${process.env.REACT_APP_BACKEND_BASE_URL}/therapy-session-teacher/update-booking/${bookingid}`, formData)
      .then(() => {
  ...
  const deleteData = (bookingid) => {
    axios
      .delete(`${process.env.REACT_APP_BACKEND_BASE_URL}/therapy-session-teacher/delete-booking/${bookingid}`)
      .then(() => {

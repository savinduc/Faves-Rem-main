...
export default function ShadowTeacherBookingManage() {
  ...
  const getBooking = () => {
    axios
      .get(`${process.env.REACT_APP_BACKEND_BASE_URL}/shadow-teacher/view-booking`)
      .then((res) => {
  ...
  const saveEdit = (bookingid) => {
    axios
      .put(`${process.env.REACT_APP_BACKEND_BASE_URL}/shadow-teacher/update-booking/${bookingid}`, formData)
      .then(() => {
  ...
  const deleteData = (bookingid) => {
    axios
      .delete(`${process.env.REACT_APP_BACKEND_BASE_URL}/shadow-teacher/delete-booking/${bookingid}`)
      .then(() => {
